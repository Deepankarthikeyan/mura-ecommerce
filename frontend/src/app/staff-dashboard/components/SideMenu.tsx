...
const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    adminOnly: true,
    children: [
      { title: "Colours", href: "/staff-dashboard/website-settings" },
      { title: "Section editor", href: "/staff-dashboard/website-settings/section-editor" },
      { title: "Themes", href: "/staff-dashboard/website-settings/themes" },
    ],
  },
  {
    title: "User Profile",
