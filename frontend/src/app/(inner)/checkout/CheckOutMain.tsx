...
export default function CheckOutMain() {
    ...
    const isDeliveryAvailable = isIndiaCountry(billingInfo.country);
    ...
    const validateForm = (): boolean => {
        ...
        if (isIndiaCountry(billingInfo.country)) {
            if (!paymentMethod) {
                                ...
                                <div className="card-header" style={{
                                    ...
                                    >
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M11 4H4C3.46957 4 2.96086 4.21071 2.58579 4.58579C2.21071 4.96086 2 5.46957 2 6V20C2 20.5304 2.21071 21.0391 2.58579 21.4142C2.96086 21.7893 3.46957 22 4 22H18C18.5304 22 19.0391 21.7893 19.4142 21.4142C19.7893 21.0391 20 20.5304 20 20V13" stroke="var(--color-primary)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                            <path d="M18.5 2.5C18.8978 2.10218 19.4374 1.87868 20 1.87868C20.5626 1.87868 21.1022 2.10218 21.5 2.5C21.8978 2.89782 22.1213 3.43739 22.1213 4C22.1213 4.56261 21.8978 5.10218 21.5 5.5L12 15L8 16L9 12L18.5 2.5Z" stroke="var(--color-primary)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                        </svg>
                                    </button>
                                </div>
                    ...
                    <div className="col-lg-4 order-2">
                        ...
                        <div className="right-card-sidebar-checkout">
                                ...
                                {couponMessage && (
                                    <p
                                        style={{
                                            margin: '8px 0 0',
                                            fontSize: '12px',
                                            color: appliedCoupon ? 'var(--color-primary)' : '#ef4444',
                                        }}
                                    >
                                        {couponMessage}
                                    </p>
                            ...
                            <div className="single-shop-list">
                                ...
                                <span
                                    className="price"
                                    style={discountAmount > 0 ? { color: 'var(--color-primary)' } : undefined}
                                >
                            ...
                            <div className="single-shop-list">
                                ...
                                <span className="price" style={{ color: 'var(--color-primary)' }}>₹{total.toFixed(2)}</span>
                            </div>
                            ...
                            <div className="cottom-cart-right-area">
                                ...
                                <div style={{ marginBottom: "20px" }}>
                                    <label
                                        ...
                                        style={{
                                            ...
                                            gap: "12px",
                                            padding: "12px 16px",
                                            border: paymentMethod === 'razorpay' ? "2px solid var(--color-primary)" : "2px solid #e5e7eb",
                                            borderRadius: "8px",
                                    ...
                                    >
                                        ...
                                        <span
                                            ...
                                            style={{
                                                ...
                                                alignItems: "center",
                                                justifyContent: "center",
                                                backgroundColor: paymentMethod === "razorpay" ? "var(--color-primary)" : "#ffffff",
                                                border: paymentMethod === "razorpay" ? "2px solid var(--color-primary)" : "2px solid #d1d5db",
                                                boxShadow: paymentMethod === "razorpay" ? "0 0 0 3px rgba(207, 6, 83, 0.12)" : "none",
                                ...
                                >
                                    ...
                                    >
                                        <span
                                            ...
                                            style={{
                                                ...
                                                inset: 0,
                                                borderRadius: "4px",
                                                border: `2px solid ${termsAccepted ? "var(--color-primary)" : "#d1d5db"}`,
                                                backgroundColor: termsAccepted ? "var(--color-primary)" : "#ffffff",
                                                display: "flex",
                                                alignItems: "center",
                                                justifyContent: "center",
                                                pointerEvents: "none",
                                                boxShadow: termsAccepted ? "0 0 0 3px rgba(207, 6, 83, 0.12)" : "none",
                                                transition: "all 0.2s ease",
                                            }}
                                        >
                                            {termsAccepted && (
                                    ...
                                    <label htmlFor="terms" style={{ cursor: "pointer", fontWeight: "bold", fontSize: "14px", pointerEvents: "none" }} onClick={(e) => e.preventDefault()}>
                                        <strong>I have read and agree to the <a href="#" onClick={(e) => { e.preventDefault(); e.stopPropagation(); }} style={{ color: "var(--color-primary)", textDecoration: "underline", pointerEvents: "auto" }}>terms and conditions</a></strong> <span style={{ color: "#ef4444" }}>*</span>
                                    </label>
                                </div>
                                {errors.terms && (
                                    <span className="error-message" style={{ color: "red", fontSize: "14px", marginBottom: "15px", display: "block" }}>
                                ...
                                >
                                    ...
                                    >
                                        We currently ship only within India. Update your billing country to continue.
                                    </div>
                                )}
                            </div>
                        </div>
