...
import ProductBuyBox from '@/components/product-page/ProductBuyBox';
...
const ProductDetailSkeleton = () => (
  <div>
    <div style={{ width: "80%", height: "32px", backgroundColor: "#e0e0e0", borderRadius: "4px", marginBottom: "12px", animation: "pulse 1.5s ease-in-out infinite" }} />
    <div style={{ width: "40%", height: "16px", backgroundColor: "#e0e0e0", borderRadius: "4px", marginBottom: "20px", animation: "pulse 1.5s ease-in-out infinite" }} />
...
const CompareElements: React.FC = () => {
  ...
  return (
    <div>
      ...
      <div className="rts-chop-details-area rts-section-gapBottom bg_light-1">
        <style>{`
        ...
        <div className="container">
          <div className="shopdetails-style-1-wrapper">
            <div className="row g-4 shop-product-cols">
                        ...
                        {isLoading ? (
                          <>
                            ...
                            <div style={{ display: "flex", gap: "10px", marginTop: "15px" }}>
                              {[1, 2, 3, 4].map((i) => (
                                <div key={i} style={{ flex: 1, height: "72px", backgroundColor: "#e0e0e0", borderRadius: "4px", animation: "pulse 1.5s ease-in-out infinite" }} />
                              ))}
                            </div>
                          </>
                        ) : (
              ...
              <div className="col-lg-4 col-md-12">
                {isLoading ? (
                  ...
                  <div className="product-buybox-wrap">
                    <ProductBuyBox product={blogPost} />
                    <div
              ...
              <div className="col-lg-4 col-md-12 rts-sticky-column-item">
