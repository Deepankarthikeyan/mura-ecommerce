...
export function getDefaultPageSeoConfig(path: string): {
  ...
  > = {
    ...
    "/about": {
      title: "About Us",
      description:
        "Learn about MuRa@23 — sale sarees sourced from artisans across India since 2010.",
    },
    "/contact": {
      title: "Contact Us",
      description: "Contact MuRa@23 in Podanur, Coimbatore for saree and order support.",
    },
    "/blog": {
      title: "Blog",
      description: "Saree stories and style notes from MuRa@23.",
    },
    "/shop": {
      title: "Shop Sale Sarees",
      description: "Browse silk, cotton, Banarasi and Kanjivaram sale sarees at MuRa@23.",
    },
    "/store": {
      title: "Our Store",
    ...
    [PRODUCT_SEO_TEMPLATE_PATH]: {
      ...
      keywords: "{title}, {category}, sarees, {siteName}",
    ...
    [BLOG_SEO_TEMPLATE_PATH]: {
      title: "{title}",
      description: "{description}",
      keywords: "{title}, {category}, saree blog, {siteName}",
      ogTitle: "{title} | {siteName}",
      ogDescription: "{description}",
      ogType: "article",
      twitterTitle: "{title} | {siteName}",
