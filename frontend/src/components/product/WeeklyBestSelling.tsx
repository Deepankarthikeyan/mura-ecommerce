...
type WeeklyBestSellingProps = {
  title?: string;
  preview?: boolean;
};

/** Home “Our Products” grid: all listing products from Mongo via `/api/products`. */
const WeeklyBestSelling: React.FC<WeeklyBestSellingProps> = ({
  title = "Our Products",
  preview = false,
}) => {
  ...
  return (
    <div className={preview ? "all-products-section is-preview" : "all-products-section"}>
                    ...
                    <div className="col-lg-12">
                      ...
                      {loading ? (
                        <div className="row g-4">
                          {Array.from({ length: preview ? 4 : 8 }, (_, i) => (
                        ...
                        <div className="row g-4">
                          {(preview ? products.slice(0, 4) : products).map((post: any, index: number) => (
                            <div
