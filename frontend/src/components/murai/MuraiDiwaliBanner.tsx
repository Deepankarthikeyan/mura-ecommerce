        ...
        <div className="dsb-layout">
          <div className="dsb-sarees" aria-hidden="true">
            <div className="dsb-saree dsb-saree--back dsb-saree--2">
              <img src="/assets/images/murai/sarees/banarasi.webp" alt="" loading="lazy" />
            </div>
            <div className="dsb-saree dsb-saree--back dsb-saree--3">
              <img src="/assets/images/murai/sarees/paithani.webp" alt="" loading="lazy" />
            </div>
            <div className="dsb-saree dsb-saree--hero">
              ...
              <img src="/assets/images/murai/sarees/kanjivaram.webp" alt="Kanjivaram silk saree" loading="lazy" />
            </div>
          </div>
