...
function ProductTabSection() {
  ...
  const [activeTab, setActiveTab] = useState<"silk" | "cotton" | "designer">("silk");

  const tabs = [
    { id: "silk" as const, label: "Silk Sarees", products: grouped.silk },
    { id: "cotton" as const, label: "Cotton Sarees", products: grouped.cotton },
    { id: "designer" as const, label: "Designer Sarees", products: grouped.designer },
  ];
    ...
    <section className="products-section">
      <div className="products-section-inner">
        ...
        <div className="product-tabs-wrap">
          <div className="product-tabs" role="tablist" aria-label="Saree categories">
            {tabs.map((tab) => (
              <button
                key={tab.id}
